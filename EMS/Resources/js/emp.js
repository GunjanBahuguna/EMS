...
function show(data) {
    ...
    for (let r of data) { 
        ...
        var newText2 = document.createTextNode(r.employeeNumber);
        var newText3 = document.createTextNode(r.firstName);
        var newText4 = document.createTextNode(r.lastName);
        var newText5 = document.createTextNode(r.departmentId);
